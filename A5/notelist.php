                    ...
                    <div class="container">
                        <div class="yournotes">
                            ...
                            <div class="note">
                                ...
                                <div class="created">Created on: <?php echo $r->created ?></div>
                                <div class="title"><?php echo $r->note_name ?></div>
                                <div class="edit">Last edit: <?php echo $r->last_edit ?><br>Total edits: <?php //Sum of all rows ?></div>
                        ...
                        <div class="sharednotes">
                            ...
                            <div class="note">
                                <div class="view"><input class="viewbutton" type="button" value="view" onclick="window.location.href='./viewnote.html'"/></div>
                                <div class="created">Created on: 01/01/2022</div>
                                <div class="title">Note 1</div>
                                <div class="edit">Last edit: 01/01/2022<br>Total edits: 1</div>
                            </div>
